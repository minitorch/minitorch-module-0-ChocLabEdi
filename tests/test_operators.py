...
def test_other(a: float, b: float, c: float) -> None:
    ...
    check that the order of operations match python i.e.
    a + b * c = a + (b * c)
    """
    # TODO: Implement for Task 0.2.
    # raise NotImplementedError("Need to implement for Task 0.2")
    return assert_close(add(a, mul(b, c)), a + b * c)
...
def test_sum_distribute(ls1: List[float], ls2: List[float]) -> None:
    ...
    i.e. both lists are of same length AND element-wise equality at each position
    """
